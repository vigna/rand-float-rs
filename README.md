...
references for future implementations. A detailed discussion of the issues
with the current techniques can be found in [this paper by Frédéric Goualard].
...
never returns nonzero numbers closer to zero than 2⁻⁵³. Details about this
specific issue can be found in [this ACM Computing Survey (section 3.1)].

This is also the same problem that Cleve Moler addressed in MatLab using [a
custom generation scheme].
...
[a custom generation scheme]: https://www.mathworks.com/content/dam/mathworks/tag-team/Objects/c/9674_randomthoughts.pdf
[this paper by Frédéric Goualard]: https://www.iccs-meeting.org/archive/iccs2020/papers/121380015.pdf
[this ACM Computing Survey (section 3.1)]: https://doi.org/10.1145/1287620.1287622
